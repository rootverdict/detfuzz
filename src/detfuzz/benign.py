...
ALLOWED_BENIGN_FIXTURE_IDS = {
    fixture.fixture_id for fixture in V1_BENIGN_FIXTURES
}
...
def execute_benign_fixture(
    ...
    # No shell=True, and the command line comes from the fixed allow-listed
    # benign fixture inventory rather than from user input.
...
def run_benign_fixtures(
    ...
    results = {
        ...
        "notes": [
            ...
            "A BENIGN_ALERT means the V1 rule matched harmless benign activity.",
        ],
    }
...
def _fixture_record(
    ...
    return {
        ...
        "prediction_met": (
            ...
            else detection_matched == prepared.fixture.predicted_v1_rule_match
        ),
    }
